// 1. Copy and paste your prototype in here and refactor into class syntax. Test
// your volume and surfaceArea methods by uncommenting the logs below:
// console.log(cuboid.volume()); // 100 console.log(cuboid.surfaceArea()); //
// 130
